...
int grid(int currentposition)
{
	...
	while (r == 0 || r == 9 || r == 10 // Check if the "food" is in a position that don't exist in the map.
		   || r == 19 || r == 20 || r == 29 || r == 30 || r == 39 || r == 40 || r == 49 || r == 50 || r == 59 || r == 60 || r == 69 || r == 70 || r == 80 || r == 90 || r == 100 || r == 110 || r == 120 || r == 130 || r == 140 || r == 150)
	{
	...
	for (;;)
	{
		if (kbhit())
		{
			...
			{																																																																																																													 // Check if player pressed "S"/"s" or Down arrow
				...
				if (currentposition != 0 && currentposition != 10 && currentposition != 20 && currentposition != 30 && currentposition != 40 && currentposition != 50 && currentposition != 60 && currentposition != 70 && currentposition != 80 && currentposition != 90 && currentposition != 100 && currentposition != 110 && currentposition != 120 && currentposition != 130 && currentposition != 140 && currentposition != 150 && currentposition != 160) // Check if player reached the limit of the map
				{
					system("cls");
					grid(currentposition);
				}
